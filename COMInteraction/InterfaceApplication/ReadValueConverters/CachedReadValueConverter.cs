...
namespace COMInteraction.InterfaceApplication.ReadValueConverters
{
    ...
    /// returning the value for the Application property of an IETWPControl, if that property is of type IApplication then this read value converter will use the interface
